...
REGISTRY: dict[str, ResourceKind] = {
    ...
    "shape": ResourceKind(
        ...
        fields=(
            "name=shape",
            "ocpus",
            "memory_gb=memory_in_gbs",
            "gpus",
            "local_disks",
            "network_gbps=networking_bandwidth_in_gbps",
        ),
    ...
    "boot_volume_backup": ResourceKind(
        ...
        fields=(*_ID, "boot_volume_id", "type", "size_gb=size_in_gbs", "created=time_created"),
    ),
    ...
    "subnet": ResourceKind(
        ...
        fields=(
            *_ID,
            ...
            "vcn_id",
            "ad=availability_domain",
            "public=prohibit_public_ip_on_vnic",
            "route_table_id",
            "security_list_ids",
            "created=time_created",
        ),
    ...
    "autonomous_database": ResourceKind(
        ...
        fields=(
            *_ID,
            ...
            "version=db_version",
            "ocpus=cpu_core_count",
            "storage_tb=data_storage_size_in_tbs",
            "is_free_tier",
            "created=time_created",
        ),
    ...
    "db_system": ResourceKind(
        ...
        fields=(
            *_ID,
            ...
            "node_count",
            "ad=availability_domain",
            "storage_gb=data_storage_size_in_gbs",
            "created=time_created",
        ),
...
def kind(resource_type: str) -> ResourceKind:
    try:
        ...
        raise KeyError(
            f"Unknown resource_type {resource_type!r}. Supported: {', '.join(RESOURCE_TYPES)}"
        ) from None
